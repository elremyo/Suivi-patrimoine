...
def add_asset(df: pd.DataFrame, nom: str, categorie: str, montant: float) -> pd.DataFrame:
...
def update_asset(df: pd.DataFrame, idx: int, nom: str, categorie: str, montant: float) -> pd.DataFrame:
